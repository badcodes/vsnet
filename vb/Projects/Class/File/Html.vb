...
Namespace MYPLACE.File
	Module Html
		...
		Public Function getHtmlTitle(ByRef HtmlFile As String, ByRef testSize As Integer) As String
			...
			Dim Reader As IO.StreamReader = New IO.StreamReader(HtmlFile, System.Text.Encoding.Default, True)
			...
			Reader.Close()
			Dim TestText As String = CStr(HeadText)
			Return StringFunction.LeftRange(testText, "title>", "</", StringComparison.OrdinalIgnoreCase, StringFunction.IfStringNotFound.ReturnEmptyStr)
		End Function
